            ...
            <div class="row g-0">
                <div class="col-lg-7 d-flex align-items-center justify-content-center">
                    <div class="d-none d-lg-block">
                        <img src="assets/img/logo_cred.png" class="img-fluid" width="600" alt="">
                    </div>
                </div>
                <div class="col-lg-5 d-flex flex-column align-items-end min-vh-100">
                    ...
                    <div class="px-lg-5 py-lg-4 p-4 w-100 align-self-center">
                        ...
                        <form class="mb-5 requires-validation" novalidate action="/realiza-login" method="post">
                            <div class="form-floating mb-4">
                                <input type="email" class="form-control border-0" id="floatingInput" placeholder="Email" autocomplete="off" name="email" required>
                        ...
                        <div class="d-flex justify-content-around mt-5">
                            ...
                            <a class="btn btn-custom2 flex-grow-1 ms-2" href="/cadastra-cliente" role="button">Ainda não sou cliente</a>
                        </div>
                    </div>

                    <div class="text-center px-lg-5 pt-lg-3 pb-lg-4 p-4 w-100 mt-auto">
                        <div class="d-inline-block mb-0">
                            <a class="btn btn-custom3" href="/home" role="button">Voltar para a home</a>
                        </div>
                    </div>
                </div>
            </div>
