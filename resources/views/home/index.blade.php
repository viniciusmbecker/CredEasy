...
<html lang="pt-br">
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar" id="home">
        ...
        <header>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
                <div class="container">
                    ...
                    <a href="#" class="">
                        <img src="{{ asset('img/CredEasy2.png') }}" width="220">
                    </a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav ms-auto align-items-lg-center">
                                    <li class="nav-item d-flex justify-content-center">
                                        <a href="{{ route('dashboard') }}" class="nav-link d-block btn ms-1 mb-2 mb-lg-0 cor-btn-nav px-2">Meu Dashboard</a>
                                    </li>
                                    <li class="nav-item d-flex justify-content-center">
                                        <a href="{{ route('logout') }}" class="nav-link d-block btn ms-1 mb-2 mb-lg-0 cor-btn-nav px-2">Sair</a>
                                    </li>
                                </ul>
                            </div>
                        @else
                            ...
                            <ul class="navbar-nav ms-auto align-items-lg-center">
                                <li class="nav-item d-flex justify-content-center">
                                    <a href="{{ route('tela.inicial') }}" class="nav-link d-block btn ms-1 mb-2 mb-lg-0 cor-btn-nav px-2">Minha Gestão</a>
                                </li>
                                <li class="nav-item d-flex justify-content-center">
                                    <a href="{{ route('logout') }}" class="nav-link d-block btn ms-1 mb-2 mb-lg-0 cor-btn-nav px-2">Sair</a>
                                </li>
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav ms-auto align-items-lg-center">
                                    <form class="form-inline d-flex align-items-center justify-content-center mb-2 mb-lg-0" id="pesquisa">
                                        <img class="m-1" src="{{ asset('img/icon.svg') }}" alt="Lupa da barra de pesquisa presente no menu" id="lupa">
                                        <input type="text" id="texto-pesquisa" placeholder="Pesquisar">
                                    </form>
                                    <li class="nav-item d-flex justify-content-center">
                                        <a href="{{ route('login') }}" class="nav-link d-block btn ms-1 mb-2 mb-lg-0 cor-btn-nav px-2">Entrar</a>
                                    </li>
                                    <li class="nav-item d-flex justify-content-center">
                                        <a href="{{ route('cliente.formulario') }}" class="nav-link d-block btn ms-1 cor-btn-nav px-2">Cadastrar</a>
                                    </li>
                                </ul>
                            </div>
                        @endguest  
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 d-none d-md-block">
                        <img class="mw-100" src="{{ asset('img/mulher-segurando-moeda.png') }}">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 d-flex justify-content-center">
                        <img src="{{ asset('img/CredEasy2.png') }}" width="230">
                    </div>
                        ...
                        <div class="row">
                            <form>
                                ...
                                <div class="input-group d-flex justify-content-end w-150 gap-1">
                                    ...
                                    <button class="btn botao-newsletter" type="button" id="button-addon2">Enviar</button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <script src="{{ asset('js/barra-de-pesquisa.js') }}"></script>
    </body>
</html>